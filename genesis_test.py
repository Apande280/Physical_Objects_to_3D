...
while True:
    ...
    # for i in range(15):
        ...
        # cam.stop_recording(save_to_filename="/home/pi/yolo/genesis/vids/project.mp4")
...
# i = 0 
# for entity in bottle.values():
#     entity.set_pos([0,0 + i,0]) 
#     i = i +.25

# for entity in cup.values():
#     entity.set_pos([0,0 - i,0]) 
#     i = i +.25

# for entity in person.values():
#     entity.set_pos([0+i,0,0]) 
#     i = i +.25

# for entity in mouse.values():
#     entity.set_pos([0+i,0,0]) 
#     i = i +.25
...
# Combine all dictionaries into one list of entities
y=0 
for d in (bottle, cup, person, mouse):
     for entity in d.values(): 
        entity.set_pos([0, y, 0]) 
        y += SPACING
